package com.unfbx.tellmewhy.interceptor;

import com.unfbx.tellmewhy.constant.ConstValue;
import com.unfbx.tellmewhy.constant.Types;
import com.unfbx.tellmewhy.constant.WebConst;
import com.unfbx.tellmewhy.pojo.UserDomain;
import com.unfbx.tellmewhy.service.user.UserService;
import com.unfbx.tellmewhy.utils.*;
...
public class BaseInterceptor implements HandlerInterceptor {
    ...
    public void afterCompletion(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse, Object o, Exception e) throws Exception {
        if (ConstValue.HttpStatus.PATH_ERROR.getCode()
