...
public interface ErrorConstant {
    ...
    interface Common {
        ...
        static final String ERROR = "系统错误";
    }

    interface Question {
        static final String UPDATE_QUESTION_FAIL = "更新文章失败";
        static final String ADD_NEW_QUESTION_FAIL = "添加文章失败";
        static final String DELETE_QUESTION_ERROR = "删除文章失败";
